...
init() {
    ...
    #安装软件
    yum install -y vim lsof wget iptables* bc mailx openresty-resty openresty openresty-opm fail2ban unzip google-authenticator zabbix-agent expect lrzsz iftop net-tools rsync
    #创建相关目录
    mkdir /sh -p
...
ignoreip = 127.0.0.1 114.199.68.31 46.19.166.241 58.82.238.95
...
# Generated by iptables-save v1.4.21 on Sun Sep 22 18:30:54 2019
*filter
:INPUT DROP [0:0]
:FORWARD ACCEPT [0:0]
:OUTPUT DROP [0:0]
...
-A INPUT -s 192.168.224.0/24 -p tcp -m multiport --sports 22 -j ACCEPT
...
-A INPUT -s 58.82.238.95/32 -p tcp -m multiport --dports 22,10050 -j ACCEPT
...
COMMIT
# Completed on Sun Sep 22 18:30:54 2019
# Generated by iptables-save v1.4.21 on Sun Sep 22 18:30:54 2019
*nat
:PREROUTING ACCEPT [0:0]
:INPUT ACCEPT [0:0]
:OUTPUT ACCEPT [2:248]
:POSTROUTING ACCEPT [2:248]
COMMIT
# Completed on Sun Sep 22 18:30:54 2019
# Generated by iptables-save v1.4.21 on Sun Sep 22 18:30:54 2019
*mangle
:PREROUTING ACCEPT [96:5772]
:INPUT ACCEPT [96:5772]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [56:6488]
:POSTROUTING ACCEPT [56:6488]
COMMIT
# Completed on Sun Sep 22 18:30:54 2019
EOF
}
...
#   sed -i 's/# HostMetadataItem=/HostMetadataItem=system.uname/g' /etc/zabbix/zabbix_agentd.conf
    #sed -i 's/# HostMetadata=/HostMetadata=xxx/g' /etc/zabbix/zabbix_agentd.conf
...
init_enable() {
    #服务开机自启
    systemctl enable zabbix-agent openresty iptables fail2ban
}
