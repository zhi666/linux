...
YOUR_IPSEC_PSK='123.sh'
YOUR_USERNAME='luke'
YOUR_PASSWORD='123.sh'
...
iptables -I INPUT -p udp -m multiport --sports 1723,1701,500,4500 -j ACCEPT
iptables -I INPUT -p udp -m multiport --dports 1723,1701,500,4500 -j ACCEPT
iptables -I INPUT -p tcp -m multiport --sports 1723,1701,500,4500 -j ACCEPT
iptables -I INPUT -p tcp -m multiport --dports 1723,1701,500,4500 -j ACCEPT

echo "require-mschap-v2" >>/etc/ppp/options.xl2tpd
systemctl restart xl2tpd >> /dev/null
